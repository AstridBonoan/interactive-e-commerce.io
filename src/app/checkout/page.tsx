  ...
  return (
    <main className="page-shell">
      ...
      <p className="mt-2 max-w-2xl text-[var(--ink-soft)]">
        Stripe Checkout is used when keys and the Supabase function are configured. Until then, the
        apartment records a local demo order so the store can be walked end to end.
      </p>
